...
interface CreateProjectTodoPopupProps {
    projectId: string | undefined;
    handleClosePopup: () => void;
}

const CreateProjectTodoPopup: React.FC<CreateProjectTodoPopupProps> = ({ projectId ,handleClosePopup }) => {
    ...
    const handleCreateTask = async (e: React.FormEvent) => {
        ...
        const response = await ProjectsService.createProjectTask(todo, projectID ?? "");
        if (response.ok) {
...
export default CreateProjectTodoPopup;